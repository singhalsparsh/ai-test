...
export const ContactPage: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Contact DeepfakeGuard — Forensic Support & Incident Reporting</title>
        <meta name="description" content="Report voice clone extortion, submit deepfake evidence for secondary forensic review, or inquire about enterprise fraud prevention endpoints." />
        <meta property="og:title" content="Contact DeepfakeGuard — Forensic Support & Incident Reporting" />
        <meta property="og:description" content="Report voice clone extortion and submit deepfake evidence for forensic review." />
      </Helmet>
      <motion.div
