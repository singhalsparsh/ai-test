...
export const PrivacyPage: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>DeepfakeGuard Privacy Policy — Zero Data Retention Charter</title>
        <meta name="description" content="DeepfakeGuard operates under a strict Zero Data Retention commitment. No audio clips, transcripts, or biometric fingerprints are ever saved to disk." />
        <meta property="og:title" content="DeepfakeGuard Privacy Policy — Zero Data Retention Charter" />
        <meta property="og:description" content="Zero data retention. No biometric fingerprinting. TLS 1.3 encrypted cloud backend." />
      </Helmet>
      <motion.div
