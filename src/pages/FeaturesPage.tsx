...
export const FeaturesPage: React.FC<FeaturesPageProps> = ({ onNavigateHome }) => {
  ...
  return (
    <>
      <Helmet>
        <title>DeepfakeGuard Features — Acoustic Forensics & Deepfake Voice Detection</title>
        <meta name="description" content="Explore DeepfakeGuard's forensic detection pipeline: Wav2Vec2 embeddings, formant analysis, neural vocoder artifact detection, real-time low-latency processing, and forensic PDF reports." />
        <meta property="og:title" content="DeepfakeGuard Features — Acoustic Forensics Pipeline" />
        <meta property="og:description" content="Wav2Vec2 embeddings, formant analysis, neural vocoder detection, real-time low-latency forensic pipeline." />
      </Helmet>
      <motion.div
